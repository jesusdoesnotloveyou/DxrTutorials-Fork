...
void Tutorial15::initDXR(HWND winHandle, uint32_t winWidth, uint32_t winHeight)
{
    mHwnd = winHandle;
...
uint32_t Tutorial15::beginFrame()
{
...
void Tutorial15::endFrame(uint32_t rtvIndex)
{
...
Tutorial15::AccelerationStructureBuffers createBottomLevelAS(ID3D12Device5Ptr pDevice, ID3D12GraphicsCommandList4Ptr pCmdList, ID3D12ResourcePtr pVB[], const uint32_t vertexCount[], uint32_t geometryCount)
{
    ...
    Tutorial15::AccelerationStructureBuffers buffers;
...
void buildTopLevelAS(ID3D12Device5Ptr pDevice, ID3D12GraphicsCommandList4Ptr pCmdList, ID3D12ResourcePtr pBottomLevelAS[2], uint64_t& tlasSize, float rotation, bool update, Tutorial15::AccelerationStructureBuffers& buffers)
{
...
void Tutorial15::createAccelerationStructures()
{
...
{
    // Compile the shader
    ID3DBlobPtr pRayGenShader = compileLibrary(L"Data/15-Shaders.hlsl", L"lib_6_3");
...
void Tutorial15::createRtPipelineState()
{
    // Need 16 subobjects:
    //  1 for DXIL library    
...
void Tutorial15::createShaderResources()
{
...
void Tutorial15::createConstantBuffers()
{
...
void Tutorial15::createShaderTable()
{
...
// Callbacks
//////////////////////////////////////////////////////////////////////////
void Tutorial15::onLoad(HWND winHandle, uint32_t winWidth, uint32_t winHeight)
{
...
{
    auto tutorial = Tutorial15();
    Framework::run(tutorial, "Tutorial 15 - Caustics");
}